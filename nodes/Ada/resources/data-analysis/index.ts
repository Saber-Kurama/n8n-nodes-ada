...
export const dataAnalysisDescription: INodeProperties[] = [
	{
		...
		options: [
			{
				...
				value: 'jsonDataAnalysis',
        action: 'Analyze JSON data',
        routing: {
          request: {
            method: 'POST',
            url: '/platform_api/PythonDataAnalysis',
          },
          send: {
            preSend: [
